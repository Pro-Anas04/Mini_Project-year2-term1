...
def SequentialSearch():
    ...
    def search():
        ...
        if position != -1:
            ...
            sqInput3.insert(0, f"พบข้อมูล {target} ที่ตำแหน่ง {position + 1}")
        else:
            sqInput3.delete(0, END)
    ...
    sqbotton4 = Button(sequential,text="Reset",font=2,bg="#9BCD9B",command=reset)
